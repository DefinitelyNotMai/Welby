...
type Factor1ResultProps = {
  isOpen: boolean;
  onClose: () => void;
};

export const Factor1Result = ({ isOpen, onClose }: Factor1ResultProps) => {
  ...
  return (
    ...
    >
      ...
      <ModalContent
        ...
        minWidth="35%"
      >
        <ModalHeader color="#000000">Social Mutualism Results</ModalHeader>
