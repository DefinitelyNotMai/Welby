...
type Factor2ResultProps = {
  isOpen: boolean;
  onClose: () => void;
};

export const Factor2Result = ({ isOpen, onClose }: Factor2ResultProps) => {
  ...
  return (
    ...
    >
      ...
      <ModalContent
        ...
        minWidth="35%"
      >
        <ModalHeader color="#000000">Sense of Being Valued Results</ModalHeader>
