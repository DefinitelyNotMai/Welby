...
type Factor5ResultProps = {
  isOpen: boolean;
  onClose: () => void;
};

export const Factor5Result = ({ isOpen, onClose }: Factor5ResultProps) => {
  ...
  return (
    ...
    >
      ...
      <ModalContent
        ...
        minWidth="35%"
      >
        <ModalHeader color="#000000">Subjective Well Being Results</ModalHeader>
