...
type Factor7ResultProps = {
  isOpen: boolean;
  onClose: () => void;
};

export const Factor7Result = ({ isOpen, onClose }: Factor7ResultProps) => {
  ...
  return (
    ...
    >
      ...
      <ModalContent
        ...
        minWidth="35%"
      >
        <ModalHeader color="#000000">Intent To Quit Results</ModalHeader>
